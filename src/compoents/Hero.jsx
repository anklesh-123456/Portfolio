...
const Hero = () => {
  ...
  return (
    <section
    id="home"
     className=' min-h-screen flex py-10 md:flex-row flex-col items-center gap-4 mt-10'>
      ...
      <div className=' flex-1'>
        ...
        <h1 className='md:text-5xl text-2xl md:leading-normal leading-10 text-white font-bold '>
          <span className=' text-cyan-600 md:text-6xl text-5xl md:mt-5'>
            Hello!
            <br />
            </span>
        ...
        <h4 className='md:text-3xl text-lg md:leading-normal leading-5 mt-4 font-bold text-gray-600'>
          Frontend Developer
          </h4>
